...
Proxy.prototype.listen = function(options, callback) {
  ...
  this.caAttrs = options.caAttrs;
  this.serverAttrs = options.serverAttrs;
  ca.create({ caFolder: this.sslCaDir, caAttrs: this.caAttrs }, function(
    err,
    ca
  ) {
    if (err) {
...
Proxy.prototype.onCertificateMissing = function (ctx, files, callback) {
  ...
  this.ca.generateServerCertificateKeys(hosts, this.serverAttrs, function (certPEM, privateKeyPEM) {
    callback(null, {
